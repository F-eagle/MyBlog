	...
	<div id="father">
		...
		<div id="right">
			<table border="0" align="center">
				...
				<form action="DoUpdateServlet?updateId=<%=articleBean.getId()%>"
					method="post">
					...
					<tr class="trheight">
						...
						<td class="format2">&nbsp;<input type="text"
							...
							value="<%=articleBean.getAuthor()%>" /></td>
